...
import type { Blog, Event, Judgment } from '../../types';
          ...
          <div className="flex border-b">
            <button
              ...
              className={`flex-1 px-6 py-4 font-semibold ${
                activeTab === 'blogs' ? 'bg-slate-900 text-white' : 'text-slate-600 hover:bg-slate-50'
              }`}
            >
              Blogs
            </button>
            <button
              ...
              className={`flex-1 px-6 py-4 font-semibold ${
                activeTab === 'events' ? 'bg-slate-900 text-white' : 'text-slate-600 hover:bg-slate-50'
              }`}
            >
              Events
            </button>
            <button
              ...
              className={`flex-1 px-6 py-4 font-semibold ${
                activeTab === 'judgments' ? 'bg-slate-900 text-white' : 'text-slate-600 hover:bg-slate-50'
              }`}
            >
              Judgments
            </button>
